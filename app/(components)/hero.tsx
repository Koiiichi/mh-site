        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden sm:flex items-center gap-6">
            ...
            <button
              ...
              className="font-newsreader italic text-sm font-medium text-muted hover:text-foreground transition-colors cursor-pointer inline-flex items-center translate-y-[2.3px]"
            >
              Now
            </button>
            <button
