  ...
  return (
    <section id="projects" className="relative">
      <div ref={sectionRef} className="grid">
        <div
          aria-hidden
          className="pointer-events-none row-start-1 col-start-1 flex flex-col opacity-0"
        >
          {projects.map((project) => (
            <div key={`${project.slug}-snap`} className="h-screen snap-start" />
          ))}
          <div className="h-[40vh] snap-end" />
        </div>
        <div className="row-start-1 col-start-1 sticky top-20 flex min-h-[75vh] flex-col justify-center gap-6 pb-16">
